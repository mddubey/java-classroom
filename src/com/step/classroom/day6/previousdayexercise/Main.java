...
//        Hamburger hamburger = new Hamburger("Some type", "Chicken", 300.0D);
//        hamburger.addCarrot();
//        hamburger.addOnion();
//        System.out.println( hamburger.getTotalPrice());

//        HealthyBurger healthyBurger = new HealthyBurger("Chicken", 350.0D);
//        healthyBurger.addCarrot();
//        healthyBurger.addOats();
//        System.out.println(healthyBurger.getTotalPrice());

        DeluxBurger deluxBurger = new DeluxBurger("Some type", "Chicken", 600.70D);
